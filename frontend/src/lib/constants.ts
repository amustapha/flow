...
export const COUNTRIES: Country[] = [
  ...
  { code: 'CN', dialCode: '+86', name: 'China', format: '### #### ####' },
  ...
  { code: 'CW', dialCode: '+599', name: 'Curaçao' },
  ...
  { code: 'NG', dialCode: '+234', name: 'Nigeria', format: '### ### ####' },
  ...
  { code: 'TC', dialCode: '+1649', name: 'Turks and Caicos Islands' },
  ...
  { code: 'VG', dialCode: '+1284', name: 'Virgin Islands (British)' },
  { code: 'VI', dialCode: '+1340', name: 'Virgin Islands (US)' },
